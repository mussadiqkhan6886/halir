            ...
            <section className='p-8 md:p-16 lg:p-24 flex flex-col bg-black relative'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-10 mb-12'>
                    <div className='border-l border-zinc-800 pl-6 group cursor-pointer'>
                        ...
                        <p className={`${magdaLig.className} text-zinc-500`}>studio@halir.com</p>
                    </div>
                    <div className='border-l border-zinc-800 pl-6 group cursor-pointer'>
                ...
                <form className='flex-grow space-y-6'>
                    ...
                    <motion.button 
                        ...
                        type="submit" 
                        className="w-full flex items-center justify-between border border-white/20 bg-zinc-950 p-4 text-[10px] font-bold tracking-[0.5em] uppercase hover:bg-white hover:text-black transition-all group"
                    >
                        Send Enquiry
