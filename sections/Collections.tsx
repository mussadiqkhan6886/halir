...
const Collections = () => {
  return (
    <section className='max-w-[1500px] mx-auto py-24 px-6 min-h-screen flex flex-col'>
      
      <div className='flex justify-between items-end mb-10 border-b border-zinc-100 pb-10'>
        <h3 className='text-6xl md:text-8xl font-bold tracking-tighter uppercase'>Collections</h3>
        ...
        {categories.map((cat, index) => (
          ...
          >
            ...
            <div className='absolute inset-0 p-8  flex flex-col justify-end text-white'>
                <span className={`${ekate.className} text-4xl text-zinc-300 mb-2 transition-all duration-700 transform md:translate-y-8 md:opacity-0 group-hover:translate-y-0 group-hover:opacity-100`}>
                    {cat.subtitle}
                </span>
